...
class MigDevice(Device):  # pylint: disable=too-many-instance-attributes
    ...
    def gpu_instance_id(self) -> Union[int, NA]:
        return nvml.nvmlQuery('nvmlDeviceGetGpuInstanceId', self.handle, default=0xFFFFFFFF)

    def compute_instance_id(self) -> Union[int, NA]:
        return nvml.nvmlQuery('nvmlDeviceGetComputeInstanceId', self.handle, default=0xFFFFFFFF)
